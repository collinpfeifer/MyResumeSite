...
const Education = () => {
  return (
    <div
      ...
      id="education"
    >
      <div className="education-container uk-flex uk-flex-center uk-flex-wrap">
        <Fade left>
          <Hover>
        ...
        <Fade top>
          <Hover>
            <div className="iu-card uk-flex uk-flex-center uk-flex-middle uk-flex-column">
              ...
              <h4 style={{ padding: '1rem', color: 'black' }}>
                Majored in Psychology and Computer Science. Participated in
                clubs found on and off campus such as Psychology Club, IUJUR,
                and Code@IU.
              </h4>
            </div>
          </Hover>
        ...
        <Fade right>
          <Hover>
            <div className="linkedin-card uk-flex uk-flex-center uk-flex-middle uk-flex-column">
              <h2 style={{ padding: '1rem', fontWeight: 'bold' }}>
                LinkedIn Learning
              </h2>
              <h4 style={{ padding: '1rem', color: 'black' }}>
